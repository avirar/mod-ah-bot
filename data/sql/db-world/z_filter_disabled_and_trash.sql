...
OR UPPER(NAME) LIKE '%DEPRICATED%'
OR UPPER(NAME) LIKE '[PH]%'
OR UPPER(NAME) LIKE '%[DEP]'
OR UPPER(NAME) LIKE '%(DND)%'
OR UPPER(NAME) LIKE '%(PT)%'
OR UPPER(NAME) LIKE '%(JEFFTEST)%'
OR UPPER(NAME) LIKE '%(MURP)%'
OR UPPER(NAME) LIKE '%(NYI)%'
